...
#ifndef _SL_OPENTHREAD_FEATURES_NCP_CONFIG_H
...
#endif
// <q>  DHCP6 Prefix Delegation (PD) built-in client feature
...
#endif
// <q>  NCP CLI support through Spinel stream
...
#endif
// <q>  Service Registration Protocol (SRP Server Advertising Proxy)
...
// <o SL_OPENTHREAD_HOST_CLEAR_PIN_TIMEOUT_MS> Timeout duration (in milliseconds) for clearing the host wakeup GPIO pin
...
#if SL_OPENTHREAD_ENABLE_HOST_WAKE_GPIO
// <gpio optional=true label="Host Wakeup GPIO Pin"> SL_OPENTHREAD_HOST_WAKEUP_GPIO Configure when host wakeup GPIO functionality is enabled
// $[GPIO_SL_OPENTHREAD_HOST_WAKEUP_GPIO]
...
#endif // _SL_OPENTHREAD_FEATURES_NCP_CONFIG_H
